...
project_folder = r'Z:\017560-12 - JEFFCO 2022 AMP08 - MAINLINE\Upgrade\2022\07\Other'
duplicates_folder = r'Z:\017560-12 - JEFFCO 2022 AMP08 - MAINLINE\Upgrade\2022\07\Duplicates'
...
for folder_name in os.listdir(project_folder):
    ...
    if os.path.isdir(folder_path):
        ...
        pdf_files = [f for f in os.listdir(folder_path) if f.endswith('.mp4')]
