...
project_folder = r'X:\017560-12 - JEFFCO 2022 AMP08 - MAINLINE\Other\2023\08'
# Create a destination folder for folders without MP4 files
destination_folder = r'X:\017560-12 - JEFFCO 2022 AMP08 - MAINLINE\Other\2023\08 pdf'
...
for foldername in os.listdir(project_folder):
    ...
    if os.path.isdir(folder_path):
        ...
        has_mp4 = any(file.endswith('.pdf') for file in os.listdir(folder_path))
